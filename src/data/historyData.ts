...
export const separationSection = {
  ...
  content:
    "Z Zawiercia pułk wyruszył w rejony Ogrodzieńca, a następnie do Podzamcza i docelowo do Woźnik. Tam został podzielony na dwa dywizjony, sprzecznie z wcześniejszymi ustaleniami, według których dębicki związek taktyczny całością sił będzie bronił rejonu Woźnik. Nowa dyrektywa nakazywała podział pułku na dwa dywizjony. Pierwszy pozostał na miejscu, a drugi skierowano do Rudnika Małego. Żołnierze musieli odtąd w osłabieniu realizować działania wzdłuż pozycji obronnej wokół Woźnik, gdzie spodziewano się głównego natarcia. Dowódca Strzelców Konnych, płk Kazimierz Kosiarski zameldował o tym gen. Zygmuntowi Piaseckiemu, zwierzchnikowi Krakowskiej Brygady Kawalerii. Rzeczywiście, niemieccy planiści pominęli w koncepcji uderzenia trudno dostępny Rudnik Mały broniony przez 1. i 2. szwadron mjr. Franciszka Rekuckiego. Wróg uderzył na Woźniki.",
} as const;
...
export const woznikiSection = {
  ...
  content: [
    ...
    "2 września szwadrony 5. Pułku Strzelców Konnych trwały osamotnione. Najpierw odepchnięto krakowski pułk ułanów, potem, po kilku kontratakach, wróg wyparł ułanów z Tarnowskich Gór. Pozycji wokół Woźnik nie zdołano utrzymać, mimo wprowadzenia do walk sił odwodowych (3. Dywizjonu Artylerii Konnej i szwadronów 3. Pułku Ułanów Śląskich).",
...
export const bilgorajSection = {
  ...
  content: [
    ...
    "16 września połączono Armię „Kraków” gen. Antoniego Szyllinga (w tym 5. Pułk)  z Armią „Lublin” gen. Tadeusza Piskora. Dowództwo nad całością sił nowo powstałej Armii „Południe” objął gen. Piskor. ",
    ...
    "W tym czasie oddziały 2. Szwadronu odepchnięto ze wzgórza. Zmasowane uderzenie nieprzyjaciela spowodowało duże straty: wielu żołnierzy zginęło, wielu zostało rannych. Poległ też sam rtm. Jarosław Chodań. Ciężko raniony w pachwinę, zmarł od upływu krwi w Tarnawatce nieopodal mostku nad Wieprzem.",
    "Kolejny oddział skierowany do wsparcia 2. Szwadronu – 4. Szwadron rtm. Bronisława Piotrowskiego – również poniósł ogromne straty wskutek silnego ostrzału artylerii. Między innymi poległ ppor. Piotr Baran, dowódca 2. plutonu 4. Szwadronu 5. Pułku Strzelców Konnych. Ze względu na brak profesjonalnej pomocy chirurgicznej, poważnie ranny w bok, podporucznik nie przeżył. Zanim jednak został ranny, 2. pluton bohatersko odparł niemieckie natarcie od strony zabudowań położonych nad stawami.",
...
export const firstDaysSection = {
  ...
  content: [
    ...
    "Tymczasem w pierwszych dniach sierpnia „Klamra” wraz ze swym sztabem zmienił dotychczasowe miejsce postoju przenosząc się z Berdechu w rejon Południka (do gajówki Władysława Klabachy). Decyzja ta była podyktowana faktem, iż Berdech znajdował się w bliskim sąsiedztwie drogi Niedźwiada - Mała, która stwarzała niebezpieczeństwo dekonspiracji.",
